        ...
        <Fragment>
            ...
            <article className="min-h-screen">
                ...
                <header className="container mx-auto px-4 lg:px-0 max-w-2xl mb-10">
                    <h1 className="text-3xl md:text-4xl font-serif font-bold text-neutral-darkest leading-tight mb-6">
                        {article.title}
                    </h1>
                    ...
                    <div className="flex items-center gap-3 pb-6 border-b border-neutral-light">
                        ...
                        <div>
                            <div className="font-medium text-neutral-darkest">
                                {article.author?.name || 'Lentera Cendekia'}
                            </div>
                    ...
                    <div className="border-t border-neutral-light pt-8">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <h3 className="text-lg font-bold text-neutral-darkest mb-1">
                                    {article.author?.name || 'Lentera Cendekia'}
                                </h3>
                                <p className="text-neutral-base text-sm leading-relaxed">
