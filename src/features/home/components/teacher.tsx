...
export function TeacherCard({ className, children, ...props }: TeacherCardProps) {
    return (
        <div className={cn('flex flex-col justify-center items-center text-center space-y-4', className)} {...props}>
            {children}
        </div>
    )
}
...
export function TeacherContent({ className, children, ...props }: TeacherContentProps) {
    return (
...
export function TeacherImage({ src, alt, width, height }: TeacherImageProps) {
    return <Image src={src ?? ''} alt={alt ?? ''} width={width ?? 100} height={height ?? 100} className="rounded-full aspect-square object-cover" />
}

export function TeacherDescription({ className, children, ...props }: ComponentProps<'p'>) {
    return (
...
export function TeacherSocial({ links, className, ...props }: TeacherSocialProps) {
    return (
