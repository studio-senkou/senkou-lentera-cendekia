                ...
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-0 items-start justify-between px-6 pt-12 lg:pt-24 pb-6">
                    ...
                    <div className="max-w-2xl">
                        <p className="text-lg text-neutral-dark">
                            Di pusat bimbingan kami, setiap siswa didukung untuk meraih prestasi akademik melalui pembelajaran yang dipersonalisasi.
                            Bergabunglah dan rasakan lingkungan belajar yang inspiratif, ramah, dan penuh semangat untuk tumbuh bersama!
                        </p>
